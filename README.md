...
- Hay copias del `.p12` y del blob DPAPI en D: y E: de este equipo. **No son una recuperación independiente ante pérdida del PC o perfil Windows**: conservar una copia cifrada del `.p12` y la contraseña en un gestor seguro o fuera del PC antes de distribuir la APK estable.
